...
namespace ur_model_namespace
{
    ...
    public:
        ...
        cc::Jacobian Ji_0_dot(const cc::JointPosition &q, 
                        int j) const;
        cc::Jacobian Jcmi_0_dot(const cc::JointPosition &q, 
                            int j) const;
    ...
    private:
        ...
        /// Yr, Theta caculet
        ////////////////////////////////
        void caculet_Theta(Parameters &Theta) const
        void caculet_Yr(Regressor &Y,
                        const cc::JointPosition &q,
                        const cc::JointVelocity &qp,
                        const cc::JointVelocity &qrp,
        ...
        /// Transformation Matrix: Ti_0 & Tcmi_0, i=1...6
        ////////////////////////////////
        void caculet_T1_0(cc::HomogeneousTransformation &T1_0,
                        const cc::JointPosition &q) const
        void caculet_T2_0(cc::HomogeneousTransformation &T2_0,
                        const cc::JointPosition &q) const
        void caculet_T3_0(cc::HomogeneousTransformation &T3_0,
                        const cc::JointPosition &q) const
        void caculet_T4_0(cc::HomogeneousTransformation &T4_0,
                        const cc::JointPosition &q) const
        void caculet_T5_0(cc::HomogeneousTransformation &T5_0,
                        const cc::JointPosition &q) const
        void caculet_T6_0(cc::HomogeneousTransformation &T6_0,
                        const cc::JointPosition &q) const

        void caculet_Tcm1_0(cc::HomogeneousTransformation &Tcm1_0,
                        const cc::JointPosition &q) const
        void caculet_Tcm2_0(cc::HomogeneousTransformation &Tcm2_0,
                        const cc::JointPosition &q) const
        void caculet_Tcm3_0(cc::HomogeneousTransformation &Tcm3_0,
                        const cc::JointPosition &q) const
        void caculet_Tcm4_0(cc::HomogeneousTransformation &Tcm4_0,
                        const cc::JointPosition &q) const
        void caculet_Tcm5_0(cc::HomogeneousTransformation &Tcm5_0,
                        const cc::JointPosition &q) const
        void caculet_Tcm6_0(cc::HomogeneousTransformation &Tcm6_0,
                        const cc::JointPosition &q) const
        ...
        //                  Jdot_i_0 & Jdot_cmi_0, i=1...6
        ////////////////////////////////
        void caculet_J1_0(cc::Jacobian &J1_0,
                        const cc::JointPosition &q) const
        void caculet_J2_0(cc::Jacobian &J2_0,
                        const cc::JointPosition &q) const
        void caculet_J3_0(cc::Jacobian &J3_0,
                        const cc::JointPosition &q) const
        void caculet_J4_0(cc::Jacobian &J4_0,
                        const cc::JointPosition &q) const
        void caculet_J5_0(cc::Jacobian &J5_0,
                        const cc::JointPosition &q) const
        void caculet_J6_0(cc::Jacobian &J6_0,
                        const cc::JointPosition &q) const

        void caculet_Jcm1_0(cc::Jacobian &Jcm1_0,
                        const cc::JointPosition &q) const
        void caculet_Jcm2_0(cc::Jacobian &Jcm2_0,
                        const cc::JointPosition &q) const
        void caculet_Jcm3_0(cc::Jacobian &Jcm3_0,
                        const cc::JointPosition &q) const
        void caculet_Jcm4_0(cc::Jacobian &Jcm4_0,
                        const cc::JointPosition &q) const
        void caculet_Jcm5_0(cc::Jacobian &Jcm5_0,
                        const cc::JointPosition &q) const
        void caculet_Jcm6_0(cc::Jacobian &Jcm6_0,
                        const cc::JointPosition &q) const
