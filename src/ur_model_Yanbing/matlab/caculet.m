...
J1_0_dot = Jacobian_dot(J1_0);
J2_0_dot = Jacobian_dot(J2_0);
J3_0_dot = Jacobian_dot(J3_0);
J4_0_dot = Jacobian_dot(J4_0);
J5_0_dot = Jacobian_dot(J5_0);
J6_0_dot = Jacobian_dot(J6_0);

Jcm1_0_dot = Jacobian_dot(Jcm1_0);
Jcm2_0_dot = Jacobian_dot(Jcm2_0);
Jcm3_0_dot = Jacobian_dot(Jcm3_0);
Jcm4_0_dot = Jacobian_dot(Jcm4_0);
Jcm5_0_dot = Jacobian_dot(Jcm5_0);
Jcm6_0_dot = Jacobian_dot(Jcm6_0);
    ...
    for i = 1:6
        for j = 1:6
            for k = 1:6
                qk = sym(['q', num2str(k)]);
                qpk = sym(['qp', num2str(k)]);
                J_dot(i,j) = J_dot(i,j) + diff( J(i,j) ,qk)*qpk;
            end
        end
    end
end